...
async function createPublishers() {
    ...
    await Promise.all([
        ...
        publisherCreate('Sony Interactive', new Date('2003-04-01'), 'Square Enix Holdings Co., Ltd. is a Japanese multinational holding company, video game production enterprise and entertainment conglomerate. It releases role-playing game franchises, such as Final Fantasy, Dragon Quest, Star Ocean, and Kingdom Hearts, among numerous others. Outside of video game publishing and development, it is also in the business of merchandise, arcade facilities, and manga publication under its Gangan Comics brand. '),
    ]);
}

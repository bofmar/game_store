...
async function createGames() {
	...
	await Promise.all([
		...
		gameCreate({ _id: '26', title: 'Kenshi', release_date: new Date('2018-12-06'), description: "A free-roaming squad based RPG. Focusing on open-ended sandbox gameplay features rather than a linear story. Be a trader, a thief, a rebel, a warlord, an adventurer, a farmer, a slave, or just food for the cannibals. Train your men up from puny victims to master warriors. ", copies_in_stock: 18, price: 26.99, publisher: publishers[8], genres: [genres[21]], consoles: [consoles[0]]}),
		gameCreate({ _id: '27', title: "Luigi's Mansion 3", release_date: new Date('2019-10-31'), description: "Luigi’s invited to the towering Last Resort hotel, but when Mario and friends go missing, our green-clad hero will have to conquer his fears to save them! Slam, blow away, and vacuum up ghosts with the all-new Poltergust G-00, and join forces with Gooigi to overcome the puzzling contraptions and mischievous boss on each themed floor. And that’s just the Last Resort. Enter the ScareScraper for 8-player local wireless* or online** co-op gameplay. ", copies_in_stock: 12, price: 59.99, publisher: publishers[3], genres: [genres[8]], consoles: [consoles[11]]}),
		gameCreate({ _id: '28', title: "Bloodstained: Ritual of the Night", release_date: new Date('2019-06-18'), description: "Bloodstained: Ritual of the Night is an exploration-focused, side-scroller action RPG by Koji Igarashi. Play as Miriam, an orphan scarred by an alchemist's curse that slowly crystallizes her body. Battle through a demon-infested castle and defeat its master to save yourself, and all of humanity! ", copies_in_stock: 18, price: 39.99, publisher: publishers[9], genres: [genres[21]], consoles: [consoles[0], consoles[9], consoles[10], consoles[11]]}),
		gameCreate({ _id: '29', title: "Crusader Kings III", release_date: new Date('2020-09-01'), description: "Love, fight, scheme, and claim greatness. Determine your noble house’s legacy in the sprawling grand strategy of Crusader Kings III. Death is only the beginning as you guide your dynasty’s bloodline in the rich and larger-than-life simulation of the Middle Ages. ", copies_in_stock: 18, price: 39.99, publisher: publishers[10], genres: [genres[20], genres[30]], consoles: [consoles[0], consoles[12], consoles[13]]}),
		gameCreate({ _id: '30', title: "Europa Universalis IV", release_date: new Date('2013-08-13'), description: "Europa Universalis IV gives you control of a nation through four dramatic centuries. Rule your land and dominate the world with unparalleled freedom, depth and historical accuracy. Write a new history of the world and build an empire for the ages.", copies_in_stock: 8, price: 39.99, publisher: publishers[10], genres: [genres[30]], consoles: [consoles[0], consoles[12], consoles[13]]}),
		gameCreate({ _id: '31', title: "Victoria III", release_date: new Date('2022-10-25'), description: "Paradox Development Studio invites you to build your ideal society in the tumult of the exciting and transformative 19th century. Balance the competing interests in your society and earn your place in the sun in Victoria 3, one of the most anticipated games in Paradox’s history.", copies_in_stock: 23, price: 49.99, publisher: publishers[10], genres: [genres[30]], consoles: [consoles[0], consoles[12], consoles[13]]}),
		gameCreate({ _id: '32', title: "Stellaris", release_date: new Date('2016-05-16'), description: "Explore a galaxy full of wonders in this sci-fi grand strategy game from Paradox Development Studios. Interact with diverse alien races, discover strange new worlds with unexpected events and expand the reach of your empire. Each new adventure holds almost limitless possibilities.", copies_in_stock: 11, price: 39.99, publisher: publishers[10], genres: [genres[30]], consoles: [consoles[0], consoles[12], consoles[13]]}),
		gameCreate({ _id: '33', title: "Inscryption", release_date: new Date('2021-10-19'), description: "Inscryption is an inky black card-based odyssey that blends the deckbuilding roguelike, escape-room style puzzles, and psychological horror into a blood-laced smoothie. Darker still are the secrets inscrybed upon the cards...", copies_in_stock: 5, price: 19.99, publisher: publishers[11], genres: [genres[38]], consoles: [consoles[0]]}),
	]);
}
